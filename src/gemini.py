...
2) Для кожної теми визнач:
   ...
   - summary: 1–4 речення підсумку. Надай власні коментарі у іронічному і сатиричному стилі. Якщо тематика пов'язана з агресією росії проти України, коментарі мають бути токсичними по відношенню до агресора.
